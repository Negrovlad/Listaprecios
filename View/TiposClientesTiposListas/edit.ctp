...
<?php echo $this->Form->create('TiposClientesTiposLista');?>
	<fieldset>
		<legend><?php echo __('Edit Tipos Clientes Tipos Lista'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TiposClientesTiposLista.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TiposClientesTiposLista.id'))); ?></li>
